...
Create an Excel spreadsheet with 5 columns and 10 rows, following proper spreadsheet conventions discussed in class. Read it into R. 
...
##### Part C
Now, rename the columns into something descriptive using R code. What variable naming convention are you using (refer to Code Organization Best Practices slides)? 
